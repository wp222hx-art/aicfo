...
(function () {
  const DICT = {
    ...
    'admin.nav.archive':       { en: '📚 Company Archive', zh: '📚 企业档案库' },
    'admin.nav.userArchive':   { en: '📁 User Finance',    zh: '📁 用户财务档案' },
    'admin.nav.waChannels':    { en: '📱 WhatsApp Channels', zh: '📱 WhatsApp 渠道' },
    'admin.nav.llmGateway':    { en: '⚡ LLM Gateway',     zh: '⚡ 模型网关' },
    'admin.nav.waConfig':      { en: '💬 WhatsApp API',    zh: '💬 WhatsApp 配置' },
    'admin.nav.uploadPortal':  { en: '🔗 Upload Portal',   zh: '🔗 上传链接' },
    'admin.nav.tgConfig':      { en: '✈️ Telegram Bot',    zh: '✈️ Telegram 机器人' },
    'admin.group.system':      { en: 'System',             zh: '系统' },
    'admin.role':              { en: 'Operations',         zh: '运营员' },
