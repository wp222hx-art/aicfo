// ================================================================================
// 账务主管 Agent / Bookkeeping Supervisor
// 由 scripts/generate-agents.js 自动生成 —— type: bookkeeping, model: gpt-5-mini
// 继承 BaseAgent，实现 run() 方法；工具通过 orchestrator 注入
// ================================================================================
const BaseAgent = require('../_base/BaseAgent');
const cfg = require('../../config/ai.config').AGENTS.bookkeeping;

class BookkeepingAgent extends BaseAgent {
  constructor(deps = {}) {
    super({ ...cfg, ...deps });
