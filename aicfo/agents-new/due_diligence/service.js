// ================================================================================
// 尽调主管 Agent
// 由 scripts/generate-agents.js 自动生成 —— type: due_diligence, model: gpt-5
// 继承 BaseAgent，实现 run() 方法；工具通过 orchestrator 注入
// ================================================================================
const BaseAgent = require('../_base/BaseAgent');
const cfg = require('../../config/ai.config').AGENTS.due_diligence;
...
module.exports = DueDiligenceAgent;
