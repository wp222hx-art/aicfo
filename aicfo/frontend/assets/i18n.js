...
(function () {
  const DICT = {
    ...
    // ====== Financial Reports (Customer) ======
    'nav.reports': { en: 'Reports', zh: '财务报表' },
    'nav.monthly': { en: 'Monthly', zh: '月度报告' },

    'reports.title': { en: 'Financial Reports — SFRS for SE', zh: '财务报表 — SFRS 中小企业准则' },
    'reports.sub': { en: 'Complete statement package: P&L, Balance Sheet, Cash Flow, Equity Changes, Trial Balance, Notes, plus ACRA XBRL and GST F5.', zh: '完整报表包：损益表、资产负债表、现金流量表、所有者权益变动表、试算平衡、附注，并自动生成 ACRA XBRL 与 GST F5。' },
    'reports.period': { en: 'Period', zh: '期间' },
    'reports.from': { en: 'From', zh: '起始' },
    'reports.to': { en: 'To', zh: '截止' },
    'reports.generate': { en: '📊 Generate Full Package', zh: '📊 生成完整报表包' },
    'reports.seed': { en: '🌱 Seed YTD Demo Data', zh: '🌱 生成年初至今模拟数据' },
    'reports.download_pdf': { en: '📥 Download PDF', zh: '📥 下载 PDF' },
    'reports.download_xbrl': { en: '📥 Download XBRL (ACRA)', zh: '📥 下载 XBRL（ACRA）' },
    'reports.tab_pnl': { en: 'P&L', zh: '损益表' },
    'reports.tab_bs': { en: 'Balance Sheet', zh: '资产负债表' },
    'reports.tab_cf': { en: 'Cash Flow', zh: '现金流量表' },
    'reports.tab_soce': { en: 'Equity Changes', zh: '权益变动' },
    'reports.tab_tb': { en: 'Trial Balance', zh: '试算平衡' },
    'reports.tab_notes': { en: 'Notes', zh: '报表附注' },
    'reports.tab_xbrl': { en: 'XBRL', zh: 'XBRL' },
    'reports.revenue': { en: 'Revenue', zh: '营业收入' },
    'reports.cogs': { en: 'Cost of Goods Sold', zh: '营业成本' },
    'reports.gross_profit': { en: 'Gross Profit', zh: '毛利' },
    'reports.gross_margin': { en: 'Gross Margin', zh: '毛利率' },
    'reports.staff': { en: 'Staff Costs', zh: '员工成本' },
    'reports.opex': { en: 'Other Operating Expenses', zh: '其他经营费用' },
    'reports.op_profit': { en: 'Operating Profit', zh: '经营利润' },
    'reports.pbt': { en: 'Profit Before Tax', zh: '税前利润' },
    'reports.tax': { en: 'Income Tax', zh: '所得税' },
    'reports.net_profit': { en: 'Net Profit', zh: '净利润' },
    'reports.net_margin': { en: 'Net Margin', zh: '净利率' },
    'reports.current_assets': { en: 'Current Assets', zh: '流动资产' },
    'reports.non_current_assets': { en: 'Non-Current Assets', zh: '非流动资产' },
    'reports.total_assets': { en: 'Total Assets', zh: '资产合计' },
    'reports.current_liab': { en: 'Current Liabilities', zh: '流动负债' },
    'reports.non_current_liab': { en: 'Non-Current Liabilities', zh: '非流动负债' },
    'reports.total_liab': { en: 'Total Liabilities', zh: '负债合计' },
    'reports.equity': { en: 'Equity', zh: '所有者权益' },
    'reports.total_equity': { en: 'Total Equity', zh: '权益合计' },
    'reports.balanced': { en: 'Balanced ✓', zh: '已平衡 ✓' },
    'reports.current_ratio': { en: 'Current Ratio', zh: '流动比率' },
    'reports.debt_equity': { en: 'Debt / Equity', zh: '负债/权益' },
    'reports.op_activities': { en: 'Operating Activities', zh: '经营活动' },
    'reports.inv_activities': { en: 'Investing Activities', zh: '投资活动' },
    'reports.fin_activities': { en: 'Financing Activities', zh: '筹资活动' },
    'reports.net_cash': { en: 'Net Change in Cash', zh: '现金净变动' },
    'reports.debit': { en: 'Debit', zh: '借方' },
    'reports.credit': { en: 'Credit', zh: '贷方' },

    // Monthly Report Centre (November)
    'monthly.title': { en: 'Monthly Report Centre — November 2025', zh: '月度报告中心 — 2025 年 11 月' },
    'monthly.sub': { en: 'One-click end-of-month pack: management accounts, CPF filing, GST interim, tax calendar, exec summary.', zh: '月结一键包：管理层财务报表、CPF 申报、GST 预估、税务日历、执行摘要。' },
    'monthly.pick_month': { en: 'Month', zh: '月份' },
    'monthly.generate': { en: '📦 Generate November Pack', zh: '📦 生成 11 月报告包' },
    'monthly.exec_summary': { en: 'Executive Summary', zh: '执行摘要' },
    'monthly.kpis': { en: 'Key Performance Indicators', zh: '关键业绩指标' },
    'monthly.highlights': { en: 'Highlights', zh: '亮点' },
    'monthly.risks': { en: 'Risk Watchlist', zh: '风险提示' },
    'monthly.runway': { en: 'Cash Runway (months)', zh: '现金跑道（月）' },
    'monthly.calendar': { en: 'Tax Calendar — Next 30 Days', zh: '税务日历 — 未来 30 天' },
    'monthly.actions': { en: 'Action Items', zh: '待办事项' },
    'monthly.filings': { en: 'Filings Checklist (CPF · GST · SDL · Board)', zh: '申报清单（CPF · GST · SDL · 董事会）' },
    'monthly.mtd': { en: 'MTD', zh: '本月' },
    'monthly.ytd': { en: 'YTD', zh: '年初至今' },
    'monthly.cpf_title': { en: 'CPF Monthly Contribution', zh: '本月 CPF 公积金' },
    'monthly.gst_title': { en: 'GST F5 Quarterly (Interim)', zh: 'GST F5 季度（预估）' },
    'monthly.deadline': { en: 'Deadline', zh: '截止日期' },
    'monthly.channel': { en: 'Channel', zh: '报送渠道' },
    'monthly.owner': { en: 'Owner', zh: '负责人' },
    'monthly.task': { en: 'Task', zh: '事项' },
    'monthly.due': { en: 'Due', zh: '到期' },
    'monthly.severity': { en: 'Severity', zh: '级别' },
    'monthly.mitigation': { en: 'Mitigation', zh: '缓解措施' },
